...
const CashSalesInvoice: React.FC<PrintPageProps> = ({ data }) => {
  ...
  <div>
    {(() => {
      const size1 = [
        "DSMC", "GUSA", "ILOI", "CALIN", "OZAD", "INAB", "VITA", "MEDE", "SAGBA", "DSMDN",
        "CARMCDO", "BAYB", "FAMY", "DSMAO", "VILLA2", "GUIN2", "DSMA", "BUUH", "DIPD2", "SALA",
        "OROH2", "CALAP2", "DIPD", "LAPU", "VALEN", "JAGN", "IPIH", "DSMSO", "CARMC", "DATH",
        "BONI", "SANP", "OROH", "SINDA", "LILD", "BOGO", "MALA", "SMCT", "TUBU", "CATM",
        "CARMB", "INIT", "TANZ", "SDIP", "CARS", "DAAN", "ALIC", "CATAR", "ALAH", "UBAY",
        "REMI", "MANO", "TUBI", "MARH", "YATI", "TORI", "DSML", "MANG", "BOHK", "LIPA",
        "DSMCN", "TALI", "DSMD", "ILID", "PARD3", "DSMT2", "BALAM", "CERI", "CALA", "BUUD",
        "DSMK", "VETH", "CATAR", "NUND2", "MOLD2", "REMI2", "CARC2", "OROD", "SILA", "BULU",
        "TRINI", "OZAH", "LOAY", "SLAP", "DSMCA", "MARA2", "DSMD2", "SUCD", "ALEN", "ILIG",
        "JIME", "PARD", "SROS", "DSMTA"
      ];
      const size2 = [
        "MOLS", "ALAD", "SLIL", "BANTA", "KATI", "SANM", "ANTI", "MARD", "TRINI2", "ELSA",
        "DASMA", "CARMO", "DSMBN", "IMED", "MARA", "CALD", "SIND", "MADRI", "DSMTG", "KABD",
        "VILLA", "DSMV", "DSMB", "CAMD", "MOLD", "AURD", "SARG", "KABA2", "TUBOD", "DIGOS",
        "VILLA", "LABD", "GUIN", "RIZD", "BALD", "IPID", "KABA", "MONKA"
      ];
      const size3 = [
        "DSMPO", "CARC", "MATI", "DSMBL", "LABA",
        "COMPO", "TACU", "CALI", "DSMLN", "DSMP",
        "PARD2"
      ];
      ...
      const size8 = ["AURH", "GENT", "SANT2", "CAMH",
        "CALAP", "PUTD", "TALI2", "TANH", "INIT2", "TANZ2",
        "MOLH", "TANZ3"
      ];
      const size9 = ["BOLOD", "MING", "RIZA", "DSMSB", "DANAO",
        "TOMAS", "CARMC2", "CATAR2", "MAND2", "MAND"
      ];
