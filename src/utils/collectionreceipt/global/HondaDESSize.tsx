...
const HondaDESSize: React.FC<PrintPageProps> = ({ data }) => {
  ...
  return (
    <div className="text-xs w-[769.13385827px] h-[396.8503937px] border">
        <div className="flex h-[19px] mt-[109.6220472406px]">
          <p className="pl-[604.72440945px] w-[143.62204724px]">{data[1]?.[CR_Date]}</p>
        </div>
        <div className="flex justify-between h-[19px] mt-[19.7952755906px]">
        ...
        <div className="h-[19px] flex w-full">
          <p className="w-[366.61417323px] ml-[225.9763779528px]">{data[1]?.[CR_AmountInWords]}</p>
          <p className="ml-[56.692913386px]">{data[1]?.[CR_AmountInFigures]}</p>
        </div>
        <div className="h-[19px] flex w-[529px] ml-[225.9763779528px]">
          <p>{data[1]?.[CR_Memo]}</p>
        </div>
    </div>
  );
